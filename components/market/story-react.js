    ...
    <div id="body">
      ...
      >
        ...
        <amp-story-page id="page-1">
          ...
          <amp-story-grid-layer template="vertical" class="text-white">
            <h1 className="text-white" color="#fff">
              Hello World
            </h1>
            <p className="text-white">This is an AMP Story.</p>
          </amp-story-grid-layer>
        </amp-story-page>
